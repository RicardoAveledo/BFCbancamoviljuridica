...
import { AprobarRechazarNominaReciboPage } from '../aprobar-rechazar-nomina-recibo/aprobar-rechazar-nomina-recibo';

/**
 * Generated class for the AprobarRechazarNominaTokenPage page.
 *
...
export class AprobarRechazarNominaTokenPage {
  public item;
  ...
  makePayment(){
      ...
      try {
       ...
       var postData = `<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
       <soap:Body>
         <RealizarPagoNomina xmlns="http://tempuri.org/">
     ...
     console.log(postData);
     //Acá hacemos la llamada al servicio que nos trae el menú dinámico según el ID del user
        this.httpClient.post("http://"+this.userSession.serverIPApp+"/WsMovil.asmx?op=RealizarPagoNomina",postData,httpOptions )
       .subscribe(data => {
        // console.log('Data: '+data['_body']); 
        }, error => {
               //Hacemos el parse tal cual como antes:
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AprobarRechazarNominaTokenPage');
  }
