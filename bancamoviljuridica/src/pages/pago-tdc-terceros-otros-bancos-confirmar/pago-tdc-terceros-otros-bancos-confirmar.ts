...
/**
 * Generated class for the PagoTdcTercerosOtrosBancosConfirmarPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-pago-tdc-terceros-otros-bancos-confirmar',
  templateUrl: 'pago-tdc-terceros-otros-bancos-confirmar.html',
})
export class PagoTdcTercerosOtrosBancosConfirmarPage {
    ...
    makeTheTransfer(){
       ...
       //Acá hacemos la llamada al servicio que nos trae el menú dinámico según el ID del user
      this.httpClient.post("http://"+this.userSession.serverIP+":57306/WsPagoTDCMovil.asmx?op=PagoTarjetaCreditoOtrosBancosTerceros",postData,httpOptions )
         .subscribe(data => {
          // console.log('Data: '+data['_body']); 
          }, error => {
                 //Hacemos el parse tal cual como antes:
