...
import { PagoTdcTercerosBfcConfirmarPage } from '../pago-tdc-terceros-bfc-confirmar/pago-tdc-terceros-bfc-confirmar';

/**
 * Generated class for the PagoTdcTercerosBfcDetallePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
@IonicPage({
  name: 'PagoTdcTercerosBfcDetallePage',
  segment: 'PagoTdcTercerosBfcDetallePage'
})
@Component({
  selector: 'page-pago-tdc-terceros-bfc-detalle',
  templateUrl: 'pago-tdc-terceros-bfc-detalle.html',
})
export class PagoTdcTercerosBfcDetallePage {
  ...
  goToPagoTDCTercerosBFCConfirmar(){
                 ...
                 parseString(xml, self, function (err, result) {
                     try{
                              ...
                              if(+montoMax >= +self.montoValue){
                                self.navCtrl.push('PagoTdcTercerosBfcConfirmarPage',{
