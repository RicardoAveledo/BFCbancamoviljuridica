...
import { TransferenciaTercerosOtrosBancosConfirmarPage } from '../transferencia-terceros-otros-bancos-confirmar/transferencia-terceros-otros-bancos-confirmar';
import { PagoTdcTercerosOtrosBancosConfirmarPageModule } from '../pago-tdc-terceros-otros-bancos-confirmar/pago-tdc-terceros-otros-bancos-confirmar.module';
import { PagoTdcTercerosOtrosBancosConfirmarPage } from '../pago-tdc-terceros-otros-bancos-confirmar/pago-tdc-terceros-otros-bancos-confirmar';

/**
 * Generated class for the PagoTdcTercerosOtrosBancosDetallePage page.
 *
...
export class PagoTdcTercerosOtrosBancosDetallePage {
  ...
  goToPagoTDCTercerosOtrosBancosConfirmar(){
  ...
  */
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad TransferenciaTercerosOtrosBancosDetallePage');
  }
